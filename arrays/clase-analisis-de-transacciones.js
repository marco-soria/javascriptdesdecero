...
const transactions = [
  ...
  console.log('Largest Transaction: ', largestTransaction) // { id: 2, description: 'Salary Deposit', amount: 2000 }
  
  // 3. Filter Purchase Transactions
  
  const purchaseTransactions = transactions.filter(transaction => transaction.amount < 0)
  console.log(' Purchase Transactions: ', purchaseTransactions) // [ { id: 1, description: 'Grocery Shopping', amount: -50 }, { id: 3, description: 'Utility Bill Payment', amount: -100 }, { id: 4, description: 'Online Purchase', amount: -30 } ]
  ...
  console.log('Specific Transaction: ', specificTransaction) // { id: 4, description: 'Online Purchase', amount: -30 }
  ...
  console.log('Index Transaction With Amount -30: ', indexTransactionWithAmount) // 3
  ...
  console.log('Udated Transactions: ', transactions) // [ { id: 1, description: 'Expense: Grocery Shopping', amount: -50 }, { id: 2, description: 'Income: Salary Deposit', amount: 2000 }, { id: 3, description: 'Expense: Utility Bill Payment', amount: -100 }, { id: 4, description: 'Expense: Online Purchase', amount: -30 } ]