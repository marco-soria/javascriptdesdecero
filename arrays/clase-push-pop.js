...
function performCartActions(action,newBook){
    switch(action){
        ...
        case REMOVE_FROM_CART_ACTION:
            ...
            }else{const removedBook=bookCart.pop()
            console.log(`Removed book from the cart: ${removedBook}`)}
            break;
        case VIEW_CART_ACTION:viewCart()
            break;
        default:console.log('Invalid action. Please choose a vaid option.')
    }
}
